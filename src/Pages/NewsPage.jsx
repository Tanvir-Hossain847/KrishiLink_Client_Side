        ...
        return (
            <div className="min-h-screen flex items-center justify-center">
                <div className="text-center">
                    ...
                    <Link to="/" className="btn bg-emerald-600 text-white">Go Home</Link>
                </div>
            </div>
        );
    }
    ...
    return (
        <div className="min-h-screen py-16">
            <div className="w-11/12 lg:w-8/12 mx-auto">
                <Link to="/" className="btn bg-emerald-600 text-white mb-8">← Back to Home</Link>
                ...
                <article className="space-y-8">
                    ...
                    <div className="space-y-4">
                        <h1 className="primary text-4xl lg:text-5xl font-bold text-gray-800">{article.title}</h1>
                        
                        <div className="flex gap-6 text-lg">
                            <p className="font-bold text-emerald-600">{article.author}</p>
                            <p className="text-gray-600">{article.date}</p>
                        </div>
                        
                        <p className="text-xl text-gray-700 font-medium border-l-4 border-emerald-600 pl-4">
                            {article.summary}
                        </p>
                    </div>
