...
const Newsletter = () => {
    ...
    return (
        <div className='w-11/12 mx-auto'>
            <div className="bg-base-100 rounded-2xl p-10 lg:p-16 shadow-xl border-y-2 border-emerald-600 text-center">
                <h2 className="text-3xl lg:text-4xl font-bold text-base-content mb-4 primary">
                    Stay Updated with <span className="text-emerald-600">KrishiLink</span>
                </h2>
                <p className="text-lg text-base-content/70 mb-8 max-w-2xl mx-auto primary">
                ...
                <form onSubmit={handleSubmit} className="flex flex-col sm:flex-row gap-4 justify-center items-center max-w-xl mx-auto">
                    <input 
                        ...
                        required
                        className="flex-1 w-full px-5 py-3 rounded-xl border-2 border-base-300 bg-base-100 focus:border-emerald-600 focus:outline-none text-base primary"
                    />
                    <button 
                        type="submit"
                ...
                <p className="text-xs text-base-content/50 mt-4 primary">
